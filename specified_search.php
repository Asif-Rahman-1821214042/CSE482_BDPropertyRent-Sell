...
$misize=$_POST['misize'];
$cookie_name = "price";
$cookie_value = $_POST['max'];
$count=mysqli_num_rows(mysqli_query($con,"SELECT * FROM persons WHERE max_p<=$cookie_value"));//for cookie query
...
setcookie($cookie_name, $cookie_value, time() + (86400 * 30), "/");//cookie function
?>
...
<div class="container-fluid text-center">
  <h1 style="font-style: italic;">Specified Search</h1>
  <?php echo $count." affordable suggested propert are avaiable fot you";?>
</div>
  ...
  while($q=mysqli_fetch_assoc($query)){
   ...
   if($count==0){
    ...
    <tr>
      ...
      <td>".$q["p_typ"]."</td>
      <td>".$q["of_type"]."</td>
      <td><a href='buyer_property_details_page.php?id=".$q["p_id"]."&cpr=5' class='btn btn-primary'>View</a></td>
      </tr></tbody>
    ";}
