  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav navbar-right">
        ...
        <?php
        if($crc==1){
          echo'<li><a href="seller_status.php">Status</a></li> ';

        }elseif ($crc==2) {
          echo'<li><a href="admin_property_status_all.php">Status</a></li> ';
        }
        else{
        echo '<li><a href="seller_property_list.php">Status</a></li>';
      }
      ?>
...
<div class="container text-center">    
  ...
  <div class="row">
    ...
    <div class="col-sm-4"> 
      <img src="<?php echo $query["url3"]?>" class="img-responsive" style="width:100%" alt="Image">
      <p>Image 3</p>    
    </div>
  </div><br>
  <div class="row">
